"
" Fruity-molokai Color Scheme
" ===================
"
" Author:   Savich Valery <Relrin78@gmail.com>
" Version:  0.1
" Note:     This color scheme based on Fruity Color Scheme by Armin Ronacher
"
set background=dark
...
let colors_name = "fruity-molokai"
...
" Specials
hi Todo         		guifg=#00d2ff   guibg=NONE	gui=italic,bold
...
hi pythonBuiltinFunc    	guifg=#F6D76B           	gui=bold
hi pythonException      	guifg=#F4C118           	gui=bold
hi pythonExClass        	guifg=#82C100           	gui=bold
